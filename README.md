# Resident Evil 3: Nemesis Recompiled

This release candidate uses PSXRecomp and the shared recomp-ui launcher.
You must supply your own SLES-02529 game disc and SCPH-5502/5552 Europe BIOS.
...
2. Start `Resident_Evil_3__Nemesis_Recompiled` (`.exe` on Windows).
